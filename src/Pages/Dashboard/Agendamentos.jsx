  ...
  return (
    <div className={S.container}>
      ...
      >
        <Box sx={styleModal}>
          <p>
            Tem certeza que deseja excluir o agendamento de: id:{agendamento.id}{" "}
            marcado para {agendamento.horario}h
          </p>
          <p>do banco de dados?</p>
          <Button onClick={() => delAgenda()} color="error" variant="contained">
            Deletar
          </Button>
          <Button
            onClick={() => handleModalOpen("delAgenda")}
            color="primary"
            variant="contained"
          >
            Voltar
      ...
      >
        <Box sx={styleModal}>
          <AgendamentoForm
            titulo={`Atualize agendamento de id:${agendamento.id} marcado para:${agendamento.horario}h`}
            text={"Atualizar"}
            agendar={attAgenda}
            data={formAgd}
            setData={handleSetFormAgd}
          />
          <Button
            onClick={() => handleModalOpen("editAgenda")}
            color="primary"
            variant="contained"
          >
            Voltar
